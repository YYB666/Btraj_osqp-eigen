...
//转置矩阵、共轭矩阵、伴随矩阵在Eigen中他们分别用transpose(),conjugate(),adjoint()表示
//LDLT分解 Eigen::LDLT 半正定或者半负定矩阵 A=P‘LDL’P
...
//C++11的Lambda表达式： [capture list] (params list) mutable exception-> return type { function body }
